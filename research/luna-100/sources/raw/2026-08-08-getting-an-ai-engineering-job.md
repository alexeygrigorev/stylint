...
1. Network: Connect with people
2. Apply: Apply for jobs even if you don’t qualify
3. Build: Create projects and share them online
4. Interview: Record what you were asked
5. Reflect: Review and improve
6. Repeat

This is a while loop. Continue networking, applying, building, and interviewing until you receive an offer you like.


The framework is a while loop
...
Job descriptions often describe the ideal candidate who doesn’t exist.
...
Recently I published a workshop at AI Shipping Labs about [tailoring your CV for AI engineering roles](https://aishippinglabs.com/workshops/tailor-cv-ai-engineering) that you may find helpful (heads up: it requires a paid subscription).
...
Another screenshot from my talk
...
[Choosing a Portfolio Project. The Definite Guide](https://alexeyondata.substack.com/p/choosing-a-portfolio-project-the)
...
[How to Write a Good README](https://alexeyondata.substack.com/p/how-to-write-a-good-readme)
...
1. Describe the project idea and the technologies
2. For each milestone, post a screenshot or a code snippet with what you built
3. When the project is ready, announce it and publish the link
4. Optionally, write a blog post

And yes, there’s another article I wrote about it:

[Benefits of Learning in Public and Why It Works](https://alexeyondata.substack.com/p/benefits-of-learning-in-public-and)
...
1. Recruiter interview: a short conversation about your background, motivation, availability, salary expectations, and basic fit
2. Theoretical interview: questions about LLMs, RAG, agents
3. Coding interview: coding, Python, SQL, code review, or practical engineering tasks
4. Project deep dive: a deeper discussion of your experience and past projects
5. System design: defining the architecture of a project
6. Behavioral interview: examples of how you dealt with different situations at work (and outside)
7. Take-home assignment: a small project you complete at home

You probably won’t get all of them: some stages may be bundled in one round, and other stages may be absent.

Now let’s go through each step of the hiring pipeline. In this article, I mostly used the materials from [AI Engineering Field Guide](https://github.com/alexeygrigorev/ai-engineering-field-guide). You will find a lot more relevant information there if you’re preparing for AI Engineering interviews.

[⭐ Star the Field Guide repo](https://github.com/alexeygrigorev/ai-engineering-field-guide)
...
You can see theoretical questions in [the “Theory” part of AI Engineering Field Guide interview preparation section](https://github.com/alexeygrigorev/ai-engineering-field-guide/blob/main/interview/questions/01-theory.md).
...
You can see technical questions in [the “Coding” part of AI Engineering Field Guide interview preparation section](https://github.com/alexeygrigorev/ai-engineering-field-guide/blob/main/interview/questions/02-coding.md).
...
I recently had a workshop about it at AI Shipping Labs. Based on it, I wrote an article: [AI Engineering Hiring Manager Interview](https://aishippinglabs.com/blog/ai-engineering-hiring-manager-interview) (it’s free).

You can see deep-dive questions in [the “Project Deep-Dive” part of AI Engineering Field Guide interview preparation section](https://github.com/alexeygrigorev/ai-engineering-field-guide/blob/main/interview/questions/03-project-deep-dive.md).
...
You can see AI system design questions in [the “AI System Design” part of AI Engineering Field Guide interview preparation section](https://github.com/alexeygrigorev/ai-engineering-field-guide/blob/main/interview/questions/04-ai-system-design.md).
...
The best way to prepare for these interviews is to research the company’s values. You can ask the recruiter about them too. For each value, prepare examples of how you demonstrated them. As a general reference, I recommend [Amazon’s Leadership Principles](https://www.amazon.jobs/content/en/our-workplace/leadership-principles).


Amazon leadership principles

You can see behavioral questions in [the “Behavioral” part of AI Engineering Field Guide interview preparation section](https://github.com/alexeygrigorev/ai-engineering-field-guide/blob/main/interview/questions/05-behavioral.md).
...
A take-home assignment for an AI engineer position
...
You can see examples of tasks in [the “Home Assignments” part of AI Engineering Field Guide interview preparation section](https://github.com/alexeygrigorev/ai-engineering-field-guide/blob/main/interview/questions/06-home-assignments.md).
...
This week, I [experimented](https://x.com/Al_Grigor/status/2084662790438998468) with building a small website using ChatGPT Work.

I’m really impressed. I sent it photos of a music festival brochure (it was Brutal Assault) and asked it to turn them into a website. It extracted the schedule, built a festival planner, and deployed it to a [public URL](https://brutal-assault-planner.alexey-s-grigoriev.chatgpt.site/) that I could share with others.
...
[(Re)Building a FAQ System for DataTalks.Club](https://alexeyondata.substack.com/p/rebuilding-a-faq-system-for-datatalksclub)

## 3) Building a full-stack application with AI

I hosted the second workshop for [AI Dev Tools Zoomcamp](https://github.com/DataTalksClub/ai-dev-tools-zoomcamp). In the first, we talked about [specification-driven development, loop and graph engineering](https://alexeyondata.substack.com/p/ai-native-development-specifications). In the second, I showed how to build an end-to-end application with frontend, backend, and a database. As an example, we built an application for system design interviews.

I’m hosting the notes on Substack, so you can read them here:

[Build and Ship a Full-Stack App with AI Coding Assistants](https://alexeyondata.substack.com/p/build-and-ship-a-full-stack-app-with)

There will be more workshops and events for AI Dev Tools Zoomcamp:

* August 10: [Test, Containerize, and Deploy an AI-Assisted App](https://luma.com/v5tjy562)
* August 18: [DevOps and Observability for AI-Built Apps](https://luma.com/ycsfxigi)
* August 24: [Pre-Course Live Q&A](https://luma.com/a8qa5s2s)
* August 31: [Course launch](https://luma.com/tsiusx8s)
...
[Join the kickoff](https://aishippinglabs.com/events/44/inference-engineering-book-club-kickoff)
...
[Register for the course](https://pythoninvest.com/course)
