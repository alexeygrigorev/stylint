...
My child asks for books about narrow subjects, and many of the books he wants either don't exist or aren't written for children. The first request wasn't about a general metals survey. He wanted chapters on palladium, tin, magnesium, titanium and beryllium. He also wanted lithium and tungsten, with particular properties, history, extraction and uses.

ChatGPT helped us make a table of contents, but its first generated chapter was poor. ChatGPT alone wasn't enough.
...
At the same time, I asked the agent to automate a website so we could read the book in a browser. I added EPUB output later because I wanted to try it. The metals book needed a lot of manual guidance. My child liked the final version.

Halfway through the metals project, his interest narrowed to gallium, potassium and their unusual alloy. We made a separate book. By then I understood the workflow well enough to put the requirements into the first prompt. The result came out well on the first attempt. The project took two GitHub issues: one for writing, and one for EPUB and MOBI publishing.
