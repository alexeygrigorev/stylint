...
The AI Engineering Buildcamp is structured around building one project while learning the parts of AI engineering that make it useful in practice. The course lasts about nine weeks, with a running example called the Documentation Agent.
