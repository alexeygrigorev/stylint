...
- S6: He chose locality-sensitive hashing (LSH) because he understood it and had implemented random projections before. He wanted to be able to debug the implementation himself without relying on an AI assistant. Do not infer that LSH was the fastest or best method.
